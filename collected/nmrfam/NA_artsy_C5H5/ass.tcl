...
set assName        ass.tab
set inName         unass.tab
set outName        ass.tabn

# constant offsets added to c.s. assignments:
set cor_X	0.0
set cor_Y	0.0
