...
#
# peak pick the reference spectrum 1st and assign the peaks using nmrDraw (name the table ass.tab)!
#
# This file uses the assignments in ass.tab to determine the peak
...
autoFit.tcl -series -dX 0.0 -dY 0.0 -inTab ass.tab \
